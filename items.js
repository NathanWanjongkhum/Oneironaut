...
const ITEM_DEFS = {
    ...
    DreamCatcher: { path: "./assets/items/DreamCatcher.png", pickable: false, bubbleOnly: true },
    Rocket: { path: "./assets/items/Rocket.png", pickable: false, bubbleOnly: true },
    SleepMask: { path: "./assets/items/SleepMask.png", pickable: false, bubbleOnly: true },
    TheStrangeLamp: { path: "./assets/items/TheStrangeLamp.png", pickable: false, bubbleOnly: true },
    Pajama: { path: "./assets/items/Pijama.png", pickable: false, bubbleOnly: true },
...
class PickupItem {
    ...
    update() {
        ...
        if (this.def.bubbleOnly) {
            if (this.BB && sg.BB && this.BB.collide(sg.BB)) {
                if (!this.game.dreamBubble) this.game.dreamBubble = new DreamBubbleOverlay(this.game);
